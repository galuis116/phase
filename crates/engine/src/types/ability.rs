...
mod tests {
    ...
    // Modern shape is `Option<ControllerRef>` (the pre-2026-Q2 boolean
    // `under_your_control` compat was removed at v0.1.54 — see git history /
    ...
    #[test]
    fn enters_under_chosen_player_index_zero_parses() {
